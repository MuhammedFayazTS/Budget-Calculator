...
var selectedAvatar;
var storedAvatar = localStorage.getItem(`${Uname}_avatar`);
var modalSubmit = document.getElementById('modalSubmit');

changeAvatar(storedAvatar);

function changeAvatar(type){
    if(type == 'Man' ){
        avatarImage.src = './images/pfp/man.png';
        modalCloseBtn.click();
        selectedAvatar = 'Man';
    }
    else if(type == "Woman"){
        avatarImage.src = './images/pfp/woman.png';
        modalCloseBtn.click();    
        selectedAvatar = 'Woman';
    }
    else if(type == 'Man1'){
        avatarImage.src = './images/pfp/man (1).png';
        modalCloseBtn.click();    
        selectedAvatar = 'Man1';
    }
    else if(type == 'Woman1'){
        avatarImage.src = './images/pfp/woman (1).png';
        modalCloseBtn.click();    
        selectedAvatar = 'Woman1';
    }
    else if(type == 'Man2'){
        avatarImage.src = './images/pfp/man (2).png';
        modalCloseBtn.click();    
        selectedAvatar = 'Man2';
    }
    else{
        avatarImage.src = './images/pfp/woman (2).png';
        modalCloseBtn.click();    
        selectedAvatar = 'Woman2';
    }
    localStorage.setItem(`${Uname}_avatar`,selectedAvatar);
}
// store the avatar
